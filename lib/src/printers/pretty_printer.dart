...
class PrettyPrinter extends LogPrinter {
  ...
  /// For example:
  /// #1      Logger.log (package:dart_logger/src/logger.dart:115:29)
  ...
  /// For example:
  /// dart:sdk_internal
  /// package:dart_logger/src/logger.dart
  ...
  bool _discardDeviceStacktraceLine(String line) {
    ...
    return match.group(2)!.startsWith('package:dart_logger');
  }
  ...
  bool _discardBrowserStacktraceLine(String line) {
    ...
    return match.group(1)!.startsWith('package:dart_logger') ||
